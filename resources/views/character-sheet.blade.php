            ...
            <td rowspan="2">
                ...
                <table>
                    <tbody>
                    	...
                    	<?php while($cskrow = mysqli_fetch_assoc($cskrs)){ 
							// Calculate the skill total
							$total = 0;
							if((in_array($cskrow['skill_id'], $class_skills)||in_array($cskrow['skill_id'].'-'.$cskrow['specialty_id'], $class_skills))&&$cskrow['ranks']>0){
								$total += 2;
							}
							$total += $cskrow['ranks'];
